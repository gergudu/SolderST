 ...
 *        (не складывается и не игнорируется). Эквивалентно
 ...
 *        нужна). Как и BUZZER_Beep() — перезапускает текущий сигнал,
 *        не ставит в очередь: более поздний вызов важнее (например,
 *        сигнал неисправности прерывает уже идущий сигнал сна).
 */
