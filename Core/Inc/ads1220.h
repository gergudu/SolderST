 ...
 *        MUX-конфигурация (REG0) идентична паяльнику (AIN1(+)/AIN0(-) —
 *        см. ads1220.c), т.к. init_chip() общая для обоих чипов. Если
 *        RTD отсоса физически разведён на AIN2/AIN3 своего чипа (как
 *        было написано в более старой версии этого комментария) —
 *        это несоответствие не проверено и не исправлено, нужна
 *        сверка со схемой.
